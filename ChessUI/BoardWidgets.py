...
class ChessBoardBase(QWidget):
    ...
    def scale_board(self, scale):
        ...
        self.pieces_img = {}
        for name in ['k', 'a', 'b', 'r', 'n', 'c', 'p']:
            self.pieces_img[name] =  scaled_image(self.base_pieces_img[name], self.paint_scale)
    ...
    def resizeEvent(self, ev):
        ...
        new_scale = min(new_width/self.base_board_width,  new_height/self.base_board_height )
